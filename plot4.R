...
#Generate plot topleft
plot(subdb$Date, subdb$Global_active_power, type = "l", ylab = "Global Active Power (kilowatts)", xlab = "")

#Generate plot topright
plot(subdb$Date,subdb$Voltage, type = "l", ylab = "Voltage",xlab="datetime")

#Generate plot bottomleft
...
#Generate plot bottomright
plot(subdb$Date,subdb$Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime")
